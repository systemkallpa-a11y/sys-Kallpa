-- ============================================================================
-- Script: Eliminar y recrear SP
-- Propósito: Limpiar versión antigua del SP y crear la nueva corregida
-- ============================================================================

-- Eliminar SP antiguo
DROP PROCEDURE IF EXISTS sp_obtener_presupuesto_detalle_completo;

-- Crear SP nuevo sin los SELECT 'PRESUPUESTO', 'DETALLES', 'RESUMEN'
DELIMITER $$
...
SELECT '✓ SP recreado exitosamente' as resultado;
