-- ============================================================================
-- SCRIPT: Actualizar SP sp_CrearRequerimientoCompleto (VERSIÓN FINAL)
-- DESCRIPCIÓN: Elimina la versión vieja e instala la versión nueva
--              que incluye observaciones en el INSERT
-- FECHA: 2026-07-16
-- ============================================================================

SELECT '========== ACTUALIZANDO SP sp_CrearRequerimientoCompleto ==========' as paso;
...
-- PASO 2: Crear SP nuevo (versión correcta con observaciones)
SELECT 'PASO 2: Instalando versión nueva' as paso;
...
BEGIN
    ...
    -- Insertar requerimiento principal CON OBSERVACIONES
    ...
    SELECT
        ...
        -- descripcion: con JSON_UNQUOTE para evitar caracteres escapados
        CASE 
...
-- PASO 3: Verificar que el SP se creó
SELECT 'PASO 3: Verificando SP creado' as paso;
SHOW PROCEDURE STATUS WHERE Name = 'sp_CrearRequerimientoCompleto' AND Db = DATABASE();

-- PASO 4: Resumen
SELECT '========== ✓ ACTUALIZACIÓN COMPLETADA ==========' as estado;
SELECT 'SP sp_CrearRequerimientoCompleto v2.0 instalado correctamente' as mensaje;
SELECT '' as linea;
SELECT 'Cambios realizados:' as cambios;
SELECT '  ✓ INSERT incluye columna observaciones' as cambio1;
SELECT '  ✓ Usa JSON_UNQUOTE para evitar caracteres escapados' as cambio2;
SELECT '  ✓ Calcula cantidad = SUM de items' as cambio3;
SELECT '  ✓ Transacciones para consistencia' as cambio4;
SELECT '' as linea;
SELECT 'Ya puedes crear requerimientos desde el frontend' as listo;
