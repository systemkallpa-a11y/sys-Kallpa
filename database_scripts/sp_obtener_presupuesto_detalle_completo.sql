-- ============================================================================
-- Stored Procedure: sp_obtener_presupuesto_detalle_completo
-- Propósito: Obtener presupuesto con todos sus detalles y cálculos
-- Fecha: 10 Julio 2026
-- Parámetro: id_presupuesto INT
-- Retorna: Información completa del presupuesto y sus items
-- ============================================================================

DELIMITER $$

CREATE PROCEDURE IF NOT EXISTS sp_obtener_presupuesto_detalle_completo(
...
-- Ejecutar para presupuesto 1:
-- CALL sp_obtener_presupuesto_detalle_completo(1);

SELECT 'Stored Procedure sp_obtener_presupuesto_detalle_completo creado exitosamente ✓' as resultado;
