-- ============================================================================
-- STORED PROCEDURE: sp_AprobarPresupuesto_Progresivo (VERSIÓN CORREGIDA)
-- PROPÓSITO: Manejar aprobación en múltiples pasos
-- LÓGICA: Registra aprobación, avanza paso, marca como APROBADO si está completo
-- ============================================================================
    ...
    ELSE
        ...
        ELSE
            ...
            ELSE
                ...
                -- REGISTRAR APROBACIÓN DEL PASO ACTUAL
                ...
                -- SI TODOS APROBADOS, CAMBIAR ESTADO
                ...
                ELSE
                    -- CREAR REGISTRO PENDIENTE PARA SIGUIENTE PASO
                    -- Así el siguiente aprobador ve la notificación
                    ...
                    SELECT 'OK' AS resultado, 'Paso aprobado' AS mensaje, v_siguiente_paso AS paso;
                END IF;
            END IF;
        END IF;
    END IF;
...
SELECT 'SP sp_AprobarPresupuesto_Progresivo creado exitosamente' as estado;
