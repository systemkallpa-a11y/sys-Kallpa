-- ============================================================================
-- SCRIPT: Corregir SP para capturar id_presupuesto correctamente
-- DESCRIPCIÓN: El SP no estaba capturando id_presupuesto al crear requerimiento
-- PROBLEMA: @v_id_presupuesto no se asignaba correctamente
-- SOLUCIÓN: Usar variable local DECLARE en lugar de variable de sesión
-- FECHA: 2026-07-16
-- ============================================================================
...
SELECT '✓ SP actualizado - Ahora captura id_presupuesto correctamente' as resultado;
