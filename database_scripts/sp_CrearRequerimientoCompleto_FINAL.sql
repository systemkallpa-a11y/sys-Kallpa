-- ========================================================================
-- SP: sp_CrearRequerimientoCompleto - VERSIÓN FINAL SIN unidad_medida
-- Fecha: 2026-07-22
-- Propósito: Crear requerimiento completo con id_material sin campo unidad_medida
-- Nota: La unidad se obtiene vía: id_material → TblMateriales → TblUnidadMedida
-- ========================================================================
