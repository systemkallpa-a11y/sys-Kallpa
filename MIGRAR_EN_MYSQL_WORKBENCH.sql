-- ========================================================================
-- MIGRACIÓN TASK 9: Eliminar unidad_medida y Actualizar SP
-- Ejecutar en MySQL Workbench conectado a: kallgwkn_kallpa_bd
-- Fecha: 22 Julio 2026
-- ========================================================================

-- PASO 1: Eliminar columna unidad_medida de TblRequerimientoDetalle
-- ========================================================================
...
-- PASO 2: Actualizar Stored Procedure sin unidad_medida
-- ========================================================================
...
BEGIN
    ...
    -- ========================================================================
    -- PASO 4: INSERTAR DETALLES DEL REQUERIMIENTO (SIN unidad_medida)
    -- ========================================================================
    IF JSON_LENGTH(p_detalles_json) > 0 THEN
        ...
        SELECT
            ...
            -- Para SERVICIOS, id_material puede ser NULL
            CASE 
                WHEN COALESCE(JSON_UNQUOTE(JSON_EXTRACT(item, '$.tipo_item')), 'MATERIAL') = 'SERVICIO' THEN NULL
                ELSE CAST(COALESCE(JSON_UNQUOTE(JSON_EXTRACT(item, '$.id_material')), 0) AS UNSIGNED)
            END,
...
-- Query para obtener unidad de medida via JOIN (ejemplo corregido)
SELECT 
    rd.id_detalle,
    rd.descripcion,
    rd.cantidad,
...
SELECT '✅ MIGRACIÓN COMPLETADA - TASK 9' AS RESULTADO;