-- ========================================================================
-- SP: sp_CrearRequerimientoCompleto - VERSIÓN FINAL CORREGIDA
-- Fecha: 2026-07-22
-- Sin unidad_medida, maneja MATERIAL y SERVICIO correctamente
-- ========================================================================
...
BEGIN
    ...
    IF p_id_presupuesto IS NOT NULL AND p_id_presupuesto > 0 THEN
        ...
        -- Obtener cantidad consumida anterior
    ...
    IF p_id_presupuesto IS NOT NULL AND p_id_presupuesto > 0 THEN
        ...
        -- Actualizar monto_gastado para compatibilidad
        UPDATE TblPresupuesto
